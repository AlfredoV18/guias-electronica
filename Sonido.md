...
###### En el siguiente ejemplo, configuramos el sistema para que el LED conmute su estado (encendido/apagado) cada vez que el módulo detecte un estímulo acústico (un aplauso) que genere un flanco de subida en la salida digital (estado lógico 1).
