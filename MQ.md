...
<small>En el siguiente ejemplo, utilizamos el MQ2 para detectar la presencia de gas de un encendedor. De igual forma se utiliza el MQ3 para medir gases alcoholicos a traves de un algodon, la cual es su especialidad.</small>
